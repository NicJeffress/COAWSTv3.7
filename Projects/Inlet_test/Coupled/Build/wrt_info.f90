...
!
     ...
     &                      sg_zwbl(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 30, MyFile)) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'bedload_coeff',         &
     &                      bedload_coeff(ng), (/0/), (/0/),            &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 35, MyFile)) RETURN
!
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 45, MyFile)) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'slopefac_wet',          &
     &                      slopefac_wet(ng), (/0/), (/0/),             &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 49, MyFile)) RETURN
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 57, MyFile)) RETURN
     ...
     &                      Erate(:,ng), (/1/), (/NST/),                &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 90, MyFile)) RETURN
