...
!
        ...
        character (len=80)  :: my_fc = "/hpc/home/nsj9/COAWST_packages/OPENMPI/bin/mpif90"
        character (len=512) :: my_fflags = "-frepack-arrays -O3 -ffast-math -O3 -ftree-vectorize -ftree-loop-linear -funroll-loops -w -ffree-form -ffree-line-length-none -frecord-marker=4 -fconvert=big-endian -I/usr/include -I/hpc/home/nsj9/COAWST_packages/MCT/include -ffree-form -ffree-line-length-none -ffree-form -ffree-line-length-none"
!
        character (len=256) :: Adir = "/hpc/home/nsj9/COAWSTv3.7/Projects/Inlet_test/Coupled"
        character (len=256) :: Hdir = "/hpc/home/nsj9/COAWSTv3.7/Projects/Inlet_test/Coupled"
        character (len=256) :: Hfile = "inlet_test.h"
        character (len=256) :: Rdir = "/hpc/home/nsj9/COAWSTv3.7"
!
