...
!
      IF (Lanafile) THEN
        ANANAME( 6)="/hpc/home/nsj9/COAWSTv3.7/Projects/Inlet_test/Coupled/ana_fsobc.h"
      END IF
      RETURN
...
!
      IF (Lanafile) THEN
        ANANAME(23)="/hpc/home/nsj9/COAWSTv3.7/Projects/Inlet_test/Coupled/ana_sediment.h"
      END IF
      RETURN
